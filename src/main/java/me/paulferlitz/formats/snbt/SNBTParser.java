...
import me.paulferlitz.formats.snbt.SNBTTokenizer.Token;
import me.paulferlitz.formats.snbt.SNBTTokenizer.TokenType;
...
public class SNBTParser
{
    ...
    private ICompoundTag parseCompound() throws SNBTException
    {
        ...
        do
        {
            ...
            value.setName(key);
            ((me.paulferlitz.core.Collection_Tag) compound).addTag(value);
    ...
    private IListTag parseList() throws SNBTException
    {
        ...
        {
            ((me.paulferlitz.core.Collection_Tag) list).addTag(value);
        }
     ...
     * @return the NBT type ID as defined in {@link me.paulferlitz.util.NBTTags}
     */
