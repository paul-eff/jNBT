...
public class BuilderPatternExample
{
    public static void main(String[] args) throws IOException
    {
        ...
        ICompoundTag gameData = (ICompoundTag) NBTBuilder.compound("GameData")
        ...
        ICompoundTag playerData = (ICompoundTag) NBTBuilder.compound("Player")
        ...
        ICompoundTag variablePlayer = (ICompoundTag) NBTBuilder.compound("VariablePlayer")
    ...
    private static IListTag createInventoryList() {
        ...
        return (IListTag) listBuilder.build();
    }
}